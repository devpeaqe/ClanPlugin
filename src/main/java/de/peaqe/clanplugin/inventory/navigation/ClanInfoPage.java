package de.peaqe.clanplugin.inventory.navigation;
...
import de.peaqe.clanplugin.util.heads.Head;
...
public class ClanInfoPage {
    ...
    public ClanInfoPage(ClanPlugin clanPlugin, ClanObject clanObject) {
