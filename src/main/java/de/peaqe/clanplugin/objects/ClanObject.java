...
public class ClanObject {
    ...
    public void delete() {
        ClanPlugin.getInstance().getClanSettingsDatabase().deleteClan(this);
    }
    ...
    public void update() {
        ClanPlugin.getInstance().getClanDatabase().updateClan(this);
    }
        ...
        this.getMembers().forEach((uuid, clanGroupModel) -> {
            ...
            if (bukkitOnlinePlayer != null) {
                if (message.contains("%s") && highlights != null) {
                    bukkitOnlinePlayer.sendMessage(ClanPlugin.getInstance().getMessages().compileMessage(
                            message, highlights
                    ));
                    return;
                }
