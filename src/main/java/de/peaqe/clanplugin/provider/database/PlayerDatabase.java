...
import de.peaqe.clanplugin.provider.util.PlayerProperty;
...
public class PlayerDatabase extends DatabaseProvider {
    ...
    public PlayerDatabase(ClanPlugin clanPlugin) {
        super(clanPlugin);
    ...
    public void createTableIfNotExists() {
        this.connect();
        try {
            this.getConnection().createStatement().execute("CREATE TABLE IF NOT EXISTS novia.player (" +
    ...
    public void registerPlayer(@NotNull Player player) {
        ...
        final var query = "INSERT INTO novia.player (`" + PlayerProperty.NAME.getValue() + "`, `" +
    ...
    public Optional<UUID> getUniqueId(@NotNull String playerName) {
        ...
        var query = "SELECT * FROM novia.player WHERE `" + PlayerProperty.NAME.getValue() + "` = ?";
    ...
    public String getName(UUID playerUniqueId) {
        ...
        var query = "SELECT * FROM novia.player WHERE `" + PlayerProperty.UUID.getValue() + "` = ?";
        this.connect();
