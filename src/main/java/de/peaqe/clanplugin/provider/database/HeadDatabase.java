...
public class HeadDatabase extends DatabaseProvider {
    ...
    public HeadDatabase(ClanPlugin clanPlugin) {
        super(clanPlugin);
    ...
    public void createTableIfNotExists() {
        this.connect();
        try {
            this.getConnection().createStatement().execute("CREATE TABLE IF NOT EXISTS novia.heads (" +
    ...
    public void insertHead(String name, UUID uuid, ItemStack itemStack) {
        ...
        var query = "INSERT INTO novia.heads (`" +
    ...
    public Optional<ItemStack> getHead(@NotNull HeadProperty headProperty, @NotNull String string) {
        ...
        var query = "SELECT `" + HeadProperty.HEAD.getValue() + "` FROM novia.heads WHERE `" +
